...
popup_reg <-  paste0("<img src = ", 
                        paste0("output/plots/", 
                               gsub("\\s+", "%20", well.table.recent$Region), ".svg"), 
                        ">")


popup_indiv <-  paste0("<img src = ", 
                        paste0("output/plots/", 
                               gsub("\\s+", "%20", well.detailed$well.name), ".svg"), 
                        ">")
...
watermap %>% 
   addPolygons(data = wells_regions, 
               ...
               popup = popup_reg,
               popupOptions = popupOptions(maxWidth = 400, minWidth = 400, 
                                          maxHeight = 800,
                                           autoPan = TRUE,
                                           keepInView = TRUE,
                                           closeOnClick = TRUE,
   ...
   addCircles(data = wells_joined, radius = 8, 
               popup = popup_indiv,
